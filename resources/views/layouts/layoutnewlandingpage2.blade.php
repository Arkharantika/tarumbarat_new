    ...
    <main id="content">
        ...
        <section class="banner-section-two">
            <div class="banner-carousel owl-carousel owl-theme">
                <div class="slide-item" style="background-image: url({{asset('images/pintuair.jpg')}});">
                ...
                <div class="slide-item" style="background-image: url({{asset('images/citarum.jpeg')}});">
                    <div class="content-box">
                        <div class="content">
                            <div class="auto-container">
                                <h2><span class="theme_color">Sistem Monitoring Hidrologi</span> untuk Saluran Irigasi <span class="theme_color">Citarum</span></h2>
                ...
                <div class="slide-item" style="background-image: url({{asset('images/citarum2.jpeg')}});">
                    <div class="content-box">
                        <div class="content">
                            <div class="auto-container">
                                <h2><span class="theme_color">Sistem Monitoring Hidrologi</span> untuk Saluran Irigasi <span class="theme_color">Citarum</span></h2>
